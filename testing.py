...
def get_arguments():
    ...
    parser.add_argument("--reload_path", type=str, default='weight/best_model.pth')
    ##################################################################################################################################
    ...
    parser.add_argument("--best_epoch", type=int, default=99)
    ...
    parser.add_argument("--result_folder", type=str, default='test_results/')
    return parser
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        with torch.no_grad():
            for iter, batch in enumerate(valloader):
                ...
                output_folder = os.path.join(args.result_folder, str(args.best_epoch))
